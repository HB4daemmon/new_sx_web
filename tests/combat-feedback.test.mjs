...
test('UI16.2 preserves the sprite packaging contract',()=>{
 assert(readFileSync('src/presentation.ts','utf8').includes("UI_REVISION='16.2'"));
 assert.equal(JSON.parse(readFileSync('data/presentation.json','utf8')).revision,'16.2');
